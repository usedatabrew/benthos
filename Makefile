...
VER_FLAGS = -X github.com/usedatabrew/benthos/v4/internal/cli.Version=$(VERSION) \
	-X github.com/usedatabrew/benthos/v4/internal/cli.DateBuilt=$(DATE)
...
fmt:
	...
	@go list -f {{.Dir}} ./... | xargs -I{} goimports -w -local github.com/usedatabrew/benthos/v4 {}
	@go mod tidy
