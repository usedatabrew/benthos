...
For users of the Go plugin APIs the import path of this module needs to be updated to `github.com/usedatabrew/benthos/v4`, like so:
...
import (
	...
	_ "github.com/usedatabrew/benthos/v4/public/components/pulsar"
)
...
[plugins.docs]: https://pkg.go.dev/github.com/usedatabrew/benthos/v4/public
